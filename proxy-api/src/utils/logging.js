...
class LoggingUtil {
  ...
  static async logSuccessfulProxy(subgraphName, endpointIndex, startTime, startUtilization, requestHistory) {
    console.log(
      await this._formatLog('[success]', subgraphName, startTime, startUtilization, requestHistory, endpointIndex)
    );
  }
